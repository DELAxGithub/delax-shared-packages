declare const JST_TIMEZONE = "Asia/Tokyo";
/**
 * JST（日本標準時）の今日の日付を取得
 ...
 * ```
 */
export declare function getJSTToday(): Date;
/**
 ...
 * ```
 */
export declare function parseJSTDate(dateStr: string): Date;
/**
 * 2つの日付をJST基準で比較
 *
 * @param date1 比較する日付1
 ...
 * ```
 */
export declare function isJSTBefore(date1: Date | string, date2: Date | string): boolean;
/**
 ...
 * ```
 */
export declare function formatJSTDate(date: Date): string;
/**
 * JST タイムゾーン定数
 * 外部で日本標準時を参照する際に使用
 */
